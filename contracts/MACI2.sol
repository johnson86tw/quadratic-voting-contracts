...
import {Poll, PollFactory, PollProcessorAndTallyer, MessageAqFactory} from "maci-contracts/contracts/Poll.sol";
import {InitialVoiceCreditProxy} from "maci-contracts/contracts/initialVoiceCreditProxy/InitialVoiceCreditProxy.sol";
import {SignUpGatekeeper2} from "./voterRegistry/SignUpGatekeeper2.sol";
import {AccQueue, AccQueueQuinaryBlankSl} from "maci-contracts/contracts/trees/AccQueue.sol";
...
/**
 * MACI2
 * @dev This contract used SignUpGatekeeper2 and updated the signUp() function for inserting merkle proof
 */
contract MACI2 is IMACI, DomainObjs, Params, SnarkCommon, Ownable {
    ...
    SignUpGatekeeper2 public signUpGatekeeper;
    ...
    constructor(
        ...
        SignUpGatekeeper2 _signUpGatekeeper,
     ...
     * @param _proof Data to pass to the SignUpGatekeeper2 register() function for the merkle proof.
    ...
    function signUp(
        ...
        signUpGatekeeper.register(msg.sender, _proof);
